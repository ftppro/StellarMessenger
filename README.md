...
The ***default*** **Message Receiver Account** is initially used when this website is opened. This account contains dfferent sample messages when the **Main Network** or **Test Network** is selected.
